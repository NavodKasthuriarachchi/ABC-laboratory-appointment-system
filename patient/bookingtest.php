...
class Appointment {
    ...
    public function bookTest($name, $mobnum, $email, $appdate, $apptime, $test, $message) {
        $cdate = date('Y-m-d');
        ...
        if ($appdate <= $cdate) {
            ...
            $sql = "INSERT INTO tblappointmentp(AppointmentNumber, Name, MobileNumber, Email, AppointmentDate, AppointmentTime, Test, Message) VALUES(:aptnumber, :name, :mobnum, :email, :appdate, :apptime, :test, :message)";
...
if(isset($_POST['submit'])) {
    ...
    // Call bookTest method with form data
    $appointment->bookTest($name, $phone, $email, $date, $time, $test, $message);
}
?>
<!doctype html>
<html lang="en">
                    ...
                    <div class="booking-form">
                        ...
                        <form role="form" method="post">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-12">
                                    <select onChange="gettests(this.value);" name="test"
                                            id="test" class="form-control" required>
