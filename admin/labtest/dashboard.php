...
if (strlen($_SESSION['damsid']) == 0) {
    ...
    $sql_new = "SELECT * from  tblappointmentp where Status is null";
    $sql_approved = "SELECT * from  tblappointmentp where Status='Approved'";
    $sql_cancelled = "SELECT * from  tblappointmentp where Status='Cancelled'";
    $sql_total = "SELECT * from  tblappointmentp";
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="widget stats-widget">
                                    ...
                                    <footer class="widget-footer bg-primary">
                                        <a href="../../technician/all-appointment.php"><small> View Detail</small></a>
