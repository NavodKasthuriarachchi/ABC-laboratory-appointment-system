                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="technician/login.php">Technician</a>
                            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="heroText d-flex flex-column justify-content-center">
                                ...
                                <p class="mb-4">ABC Laboratory provides advanced testing services designed to support both healthcare professionals and patients. Our modern facilities and expert team ensure accurate and prompt results for a wide variety of tests, from standard check-ups to specialized assessments. </p>

                                <div class="heroLinks d-flex flex-wrap align-items-center">
                                    <a class="custom-link me-4" href="#about" data-hover="Learn More">Learn More</a>

                                    <p class="contact-phone mb-0"><i class="bi-phone"></i> +94 32 5789248</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-5 col-12 mx-auto">
                            <div class="featured-circle bg-white shadow-lg d-flex justify-content-center align-items-center">
                                <p class="featured-text"><span class="featured-number">25</span> Years<br> of Experiences</p>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-6 col-12 my-4 my-lg-0">
                        ...
                        <p>132 B High Level Rd, Nugegoda 10250</p>
                    </div>
