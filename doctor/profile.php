...
class DoctorProfile {
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control" name="specializationid">
                                    <option value="' . htmlentities($row->ID) . '">' . htmlentities($row->sssp) . '</option>';
    ...
    private function displaySpecializations() {
        ...
        if ($query->rowCount() > 0) {
            foreach ($results as $row) {
                echo '<option value="' . htmlentities($row->ID) . '">' . htmlentities($row->Specialization) . '</option>';
            }
        }
    }
}

$doctorProfile = new DoctorProfile($dbh);
?>
                ...
                <div class="col-md-12">
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <?php $doctorProfile->updateProfile(); ?>
                            <?php $doctorProfile->displayProfileForm(); ?>
                        </div><!-- .widget-body -->
                    </div><!-- .widget -->
                </div><!-- END column -->
            </div><!-- .row -->
