...
class SignupTechnician {
    ...
    public function registerTechnician() {
        if (isset($_POST['submit'])) {
            ...
            $ret = "SELECT Email FROM tbltechnician WHERE Email=:email";
            ...
            if ($query->rowCount() == 0) {
                $sql = "INSERT INTO tbltechnician(FullName, MobileNumber, Email, Password) VALUES (:fname, :mobno, :email, :password)";
...
$signupTechnician = new SignupTechnician($dbh);
