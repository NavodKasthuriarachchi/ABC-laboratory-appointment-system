...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT Email FROM tbltechnician WHERE Email=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tbltechnician set Password=:newpassword where Email=:email and MobileNumber=:mobile";
