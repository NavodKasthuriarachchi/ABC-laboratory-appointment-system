    ...
    if (isset($_FILES["file"]) && $_FILES["file"]["error"] == 0) {
        ...
        if (!in_array($file_type, $allowed_types)) {
            ...
            if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
                ...
                $test = $_POST['test'];
                $patient = $_POST['patient']; // Fetch selected test value
                ...
                $sql = "INSERT INTO tblreport (filename, filesize, filetype, test, patient, appointmentnumber) VALUES ('$filename', $filesize, '$filetype', '$test', '$patient', '$appointmentnumber')";
